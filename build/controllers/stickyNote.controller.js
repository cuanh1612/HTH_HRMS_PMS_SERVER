...
const stickyNoteController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //Get data user
        const existingUser = decode.role === "Client" ? yield Client_entity_1.Client.findOne({
            where: {
                id: decode.userId
            }
        }) : yield Employee_entity_1.Employee.findOne({
            where: {
                id: decode.userId,
            },
        });
        ...
        const createNote = yield StickyNote_entity_1.Sticky_note.create(Object.assign(Object.assign({}, dataNote), (existingUser.role === "Client" ? { client: existingUser } : { employee: existingUser }))).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingNote = yield StickyNote_entity_1.Sticky_note.findOne({
            where: {
                id: Number(id)
            },
            relations: {
    ...
    getByEmployee: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const stickyNotes = decode.role === "Client" ? yield StickyNote_entity_1.Sticky_note.find({
            where: {
                client: {
        ...
        }) : yield StickyNote_entity_1.Sticky_note.find({
            where: {
                employee: {
                    id: existingUser === null || existingUser === void 0 ? void 0 : existingUser.id
                }
