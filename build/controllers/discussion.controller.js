...
const discussionController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //Create new discussion
        const createdDiscussion = yield Discussion_entity_1.Discussion.create(Object.assign(Object.assign({}, (client
            ? {
    ...
    getByContract: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //Get all discussion
        const discussions = yield Discussion_entity_1.Discussion.find({
            where: {
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingDiscussion = yield Discussion_entity_1.Discussion.findOne({
            where: {
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (getMailAuthor === email_author) {
            //update discussion
            yield Discussion_entity_1.Discussion.update(Number(discussionId), {
                content,
            });
        }
        else {
