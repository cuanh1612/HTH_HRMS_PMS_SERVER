...
const taskCommentController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createdTaskComment = yield Task_Comment_entity_1.Task_comment.create({
            task: existingTask,
    ...
    getByTask: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const taskComments = yield Task_Comment_entity_1.Task_comment.find({
            where: {
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingTaskComment = yield Task_Comment_entity_1.Task_comment.findOne({
            where: {
