...
const taskCategoryController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const taskCategory = yield Task_Category_1.Task_Category.create(dataNewCategory).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Task_Category_1.Task_Category.update(existingTaskCategory.id, Object.assign({}, dataUpdate));
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    getAll: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const taskCategories = yield Task_Category_1.Task_Category.find();
        return res.status(200).json({
            code: 200,
            success: true,
            taskCategories,
