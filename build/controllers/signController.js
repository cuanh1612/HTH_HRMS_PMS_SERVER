...
const signController = {
    createConTractSign: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //Create new sign 
        const newSign = yield Sign_1.Sign.create(Object.assign({}, dataNewSign)).save();
        //Update relationship with contract
        yield Contract_1.Contract.update(existingContract.id, {
            sign: newSign
        });
    ...
    createJobOfferSign: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Job_Offer_Letter_1.Job_offer_letter.update(existingJobOfferLetter.id, {
            sign: newSign
        });
        return res.status(200).json({
            code: 200,
