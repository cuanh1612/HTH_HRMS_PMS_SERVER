...
const jobApplicationFileController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (Array.isArray(files)) {
            files.map((file) => __awaiter(void 0, void 0, void 0, function* () {
                yield Job_Application_File_entity_1.Job_application_file.create(Object.assign(Object.assign({}, file), { job_application: existingJobApplication })).save();
            }));
        }
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingJobApplicationFile = yield Job_Application_File_entity_1.Job_application_file.findOne({
            where: {
    ...
    getAll: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const jobApplicationFiles = yield Job_Application_File_entity_1.Job_application_file.find({
            where: {
                job_application: {
                    id: Number(jobApplicationId),
                },
