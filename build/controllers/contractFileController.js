...
const contractFileController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (Array.isArray(files)) {
            files.map((file) => __awaiter(void 0, void 0, void 0, function* () {
                yield Contract_File_1.Contract_file.create(Object.assign(Object.assign({}, file), { contract: existingContract })).save();
            }));
        }
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingContractFile = yield Contract_File_1.Contract_file.findOne({
            where: {
    ...
    getAll: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const contractFiles = yield Contract_File_1.Contract_file.find({
            where: {
                contract: {
                    id: Number(contractId)
                }
