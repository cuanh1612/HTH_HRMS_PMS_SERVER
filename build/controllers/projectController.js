...
const projectController = {
    ...
    changeStatus: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!project_status ||
            project_status !== Project_1.enumProjectStatus.CANCELED ||
            project_status !== Project_1.enumProjectStatus.FINISHED ||
            project_status !== Project_1.enumProjectStatus.IN_PROGRESS ||
            project_status !== Project_1.enumProjectStatus.NOT_STARTED ||
            project_status !== Project_1.enumProjectStatus.ON_HOLD)
            return res.status(400).json({
                code: 400,
                success: false,
    ...
    projectStatusByClient: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const exisitingClient = yield Client_1.Client.findOne({
            where: {
                id: Number(clientId)
            }
        });
        ...
        const manager = (0, typeorm_1.getManager)('huprom');
        const projectStatus = yield manager.query(`SELECT project.project_status, COUNT(project.id) from project WHERE project."clientId" = ${exisitingClient.id} GROUP BY project.project_status`);
        return res.status(200).json({
            code: 200,
            success: true,
