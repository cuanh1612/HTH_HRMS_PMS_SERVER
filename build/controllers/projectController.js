...
const projectController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //create project file
        const createdProject = yield Project_1.Project.create(Object.assign(Object.assign({}, dataNewProject), { start_date: new Date(dataNewProject.start_date), deadline: new Date(dataNewProject.deadline), employees: projectEmployees })).save();
