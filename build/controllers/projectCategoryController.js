...
const projectCategoryController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createdProjectCategory = yield Project_Category_1.Project_Category.create(dataNewCategory).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingProjectCategory = yield Project_Category_1.Project_Category.findOne({
            where: {
                id: Number(id),
            },
        });
        ...
        yield Project_Category_1.Project_Category.update(existingProjectCategory.id, Object.assign({}, dataUpdateProjectCategory));
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    getAll: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const projectCategories = yield Project_Category_1.Project_Category.find();
        return res.status(200).json({
            code: 200,
            success: true,
