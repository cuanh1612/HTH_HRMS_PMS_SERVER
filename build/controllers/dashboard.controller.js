...
const dashBoardController = {
    totalClients: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const totalClients = yield Client_entity_1.Client.createQueryBuilder('client').getCount();
    ...
    totalEmployees: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const totalEmployees = yield Employee_entity_1.Employee.createQueryBuilder('employee').getCount();
        return res.status(200).json({
            code: 200,
            success: true,
            totalEmployees,
    ...
    totalProjects: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const totalProjects = yield Project_entity_1.Project.createQueryBuilder('project').getCount();
        return res.status(200).json({
            code: 200,
            success: true,
            totalProjects,
    ...
    pendingTasks: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const pendingTasks = yield Task_entity_1.Task.createQueryBuilder('task')
    ...
    todayAttendance: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const todayAttendance = yield Attendance_entity_1.Attendance.createQueryBuilder('attendance')
    ...
    pendingTasksRaw: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const pendingTasksRaw = yield Task_entity_1.Task.createQueryBuilder('task')
            .leftJoinAndSelect('task.status', 'status')
    ...
    contractsGenerated: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const contractsGenerated = yield Contract_entity_1.Contract.createQueryBuilder('contract').getCount();
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    latestClients: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const data = yield Client_entity_1.Client.createQueryBuilder('client').getMany();
    ...
    lateAttendance: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const latestClients = yield Client_entity_1.Client.createQueryBuilder('client').limit(10).getMany();
        return res.status(200).json({
            code: 200,
            success: true,
