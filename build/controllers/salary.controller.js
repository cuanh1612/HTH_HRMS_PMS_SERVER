...
const salaryController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingEmployee = yield Employee_entity_1.Employee.find({
            where: {
                id: employee,
            },
        });
        ...
        //Create new salary
        const createdSalary = yield Salary_entity_1.Salary.create(Object.assign({}, dataNewSalary)).save();
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //Check exist salary
        const existingSalary = yield Salary_entity_1.Salary.findOne({
            where: {
                id: Number(salaryId),
            },
        });
    ...
    getAll: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const salaries = yield Employee_entity_1.Employee.createQueryBuilder('employee')
    ...
    getHistoryByUser: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const historySalary = yield Employee_entity_1.Employee.createQueryBuilder('employee')
