...
const interviewController = {
    getAll: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        var interviews = yield Interview_entity_1.Interview.find({
            relations: {
                candidate: true,
                interviewer: true,
            },
    ...
    getNewByDate: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const interviews = yield Interview_entity_1.Interview.find({
            relations: {
                candidate: {
                    jobs: true,
                },
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existCandidate = yield Job_Application_entity_1.Job_Application.findOne({
            where: {
                id: candidate,
            },
            relations: {
        ...
        yield Promise.all(interviewer.map((interviewId) => __awaiter(void 0, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
                const existingInterviewer = yield Employee_entity_1.Employee.findOne({
                    where: {
                        id: interviewId,
                    },
                });
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { id } = req.params;
        const listValidInterviewer = [];
        const existInterview = yield Interview_entity_1.Interview.findOne({
            where: {
                id: Number(id),
            },
        });
