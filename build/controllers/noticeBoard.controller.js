...
const noticeBoardController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createNoticeBoard = yield Notice_Board_entity_1.Notice_board.create({
            notice_to,
            heading,
            details,
        }).save();
        //Create notification for employees or clients
        if (notice_to === Notice_Board_entity_1.enumNoticeTo.CLIENTS) {
            //Get all clients
        ...
        else if (notice_to === Notice_Board_entity_1.enumNoticeTo.EMPLOYEES) {
            //Get all employees
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingNotice = yield Notice_Board_entity_1.Notice_board.findOne({
            where: {
    ...
    getAll: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        switch (select) {
            case 'employees':
                noticeBoards = yield Notice_Board_entity_1.Notice_board.find({
                    where: {
                        notice_to: 'Employees',
                    },
                });
    ...
    getAllByNoticeTo: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //get all notice
        const noticeBoards = yield Notice_Board_entity_1.Notice_board.find({
            where: {
                notice_to: noticeTo,
            },
        });
