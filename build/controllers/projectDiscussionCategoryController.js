...
const projectDiscussionCategoryController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield Project_Discussion_Category_1.Project_discussion_category.create(dataNewCategory).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingData = yield Project_Discussion_Category_1.Project_discussion_category.findOne({
            where: {
                id: Number(id),
            },
        });
        ...
        yield Project_Discussion_Category_1.Project_discussion_category.update(existingData.id, Object.assign({}, dataUpdate));
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    getAll: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const data = yield Project_Discussion_Category_1.Project_discussion_category.find();
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    getDetail: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        const existingCategory = yield Project_Discussion_Category_1.Project_discussion_category.findOne({
            where: {
                id: Number(id),
            },
        });
