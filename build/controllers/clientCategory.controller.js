...
const clientCategoryController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createdClientCategory = yield Client_Category_entity_1.Client_Category.create(dataNewClientCategory).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Client_Category_entity_1.Client_Category.update(existingClientCategory.id, Object.assign({}, dataUpdateCategory));
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    getAll: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const clientCategories = yield Client_Category_entity_1.Client_Category.find();
        return res.status(200).json({
            code: 200,
            success: true,
            clientCategories,
