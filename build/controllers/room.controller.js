...
const roomController = {
    getByTitle: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const room = yield Room_entity_1.Room.findOne({
            where: {
                title,
            },
            relations: {
    ...
    getAll: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const yourRooms = yield Room_entity_1.Room.find({
            where: {
                empl_create: {
        ...
        const filter = existEmployee
            ...
            : existClient
                ...
                : undefined;
        const otherRooms = yield Room_entity_1.Room.find({
            where: filter,
            relations: {
                empl_create: true,
                employees: true,
    ...
    getDetail: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        const existRoom = yield Room_entity_1.Room.findOne({
            where: {
                id: Number(id),
            },
            relations: {
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Room_entity_1.Room.delete({
            id: Number(id),
        });
        return res.status(200).json({
            code: 200,
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Promise.all(clients.map((id) => __awaiter(void 0, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
                const data = yield Client_entity_1.Client.findOne({
                    where: {
                        id,
                    },
                });
        ...
        yield Promise.all(employees.map((id) => __awaiter(void 0, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
                const data = yield Employee_entity_1.Employee.findOne({
                    where: {
                        id,
                    },
                });
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Room_entity_1.Room.create({
