...
const notificationController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createNotification = yield Notification_entity_1.Notification.create(Object.assign({ url,
    ...
    getAllByCurrentUser: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const allNotifications = yield Notification_entity_1.Notification.find({
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingNotification = yield Notification_entity_1.Notification.findOne({
            where: {
        ...
        //Check author
        if (!(existingUser.role === 'Client' && existingUser.id === existingNotification.client.id) &&
        ...
        //Remove notification
        yield existingNotification.remove();
        return res.status(200).json({
            code: 200,
            success: true,
