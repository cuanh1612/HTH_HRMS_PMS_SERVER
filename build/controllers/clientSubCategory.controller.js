...
const clientSubCategoryController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingClientCategory = yield Client_Category_entity_1.Client_Category.findOne({
            where: {
        ...
        //Create new client sub category
        const createdSubCategory = yield Client_Sub_Category_entity_1.Client_Sub_Category.create(Object.assign({}, dataNewSubCategory)).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingSubCategory = yield Client_Sub_Category_entity_1.Client_Sub_Category.findOne({
            where: {
                id: Number(id),
            },
        });
        ...
        //Update client sub category
        yield Client_Sub_Category_entity_1.Client_Sub_Category.update(existingSubCategory.id, Object.assign({}, dataUpdateSubCategory));
        return res.status(200).json({
            code: 200,
            success: true,
    ...
    getAll: (0, catchAsyncError_1.default)((_, res) => __awaiter(void 0, void 0, void 0, function* () {
        const clientSubCategories = yield Client_Sub_Category_entity_1.Client_Sub_Category.find();
        return res.status(200).json({
            code: 200,
            success: true,
            clientSubCategories,
