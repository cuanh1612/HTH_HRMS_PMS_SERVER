...
const interviewFileController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (Array.isArray(files)) {
            files.map((file) => __awaiter(void 0, void 0, void 0, function* () {
                yield Interview_File_1.Interview_file.create(Object.assign(Object.assign({}, file), { interview: existingInterview })).save();
            }));
        }
    ...
    getAll: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const interviewFiles = yield Interview_File_1.Interview_file.find({
            where: {
                interview: {
                    id: Number(interviewId)
                }
