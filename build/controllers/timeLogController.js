...
const timeLogController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //Create time log
        const newTimeLog = yield Time_Log_1.Time_log.create(Object.assign(Object.assign({}, dataNewTimeLog), { starts_on_date: new Date(dataNewTimeLog.starts_on_date), ends_on_date: new Date(dataNewTimeLog.ends_on_date), project: existingProject, task: existingTask, employee: existingEmployee })).save();
        ...
        //Get total earning
        const existingHourlyRate = yield Hourly_rate_project_1.Hourly_rate_project.findOne({
            where: {
                employee: {
