...
const projectNoteController = {
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (note_type === Project_Note_entity_1.enumNoteType.PRIVATE) {
        ...
        yield Project_Note_entity_1.Project_note.create(Object.assign(Object.assign({}, dataNewProjectNote), { employees: listEmployeesAdd })).save();
    ...
    update: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existProjectNote = yield Project_Note_entity_1.Project_note.findOne({
            where: {
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { projectNoteId } = req.params;
        //Check exist project note
        const existingProjectNote = yield Project_Note_entity_1.Project_note.findOne({
            where: {
                id: Number(projectNoteId),
            },
            relations: {
    ...
    getByProject: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const projectNotesPublic = yield Project_Note_entity_1.Project_note.find({
            where: {
                note_type: Project_Note_entity_1.enumNoteType.PUBLIC,
                project: {
                    id: Number(projectId),
                },
            },
        ...
        if (existingUser.role === 'Client' && existingProject.client.id === existingUser.id) {
            ...
            const projectNotesClient = yield Project_Note_entity_1.Project_note.find({
                where: {
        ...
        if (existingProject.employees.some((employeeItem) => employeeItem.id === existingUser.id)) {
            const projectNotesForClient = yield Project_Note_entity_1.Project_note.find({
                where: {
                    project: {
                        id: Number(projectId),
                    },
