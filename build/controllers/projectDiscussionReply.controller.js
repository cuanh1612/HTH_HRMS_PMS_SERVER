...
const projectDiscussionReplyController = {
    ...
    create: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingProjectDiscussionRoom = yield Project_Discussion_Room_entity_1.Project_Discussion_Room.findOne({
            where: {
    ...
    getByProjectDiscussionRoom: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const replies = yield Project_Discussion_Reply_entity_1.Project_discussion_reply.find({
            where: {
    ...
    delete: (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const existingReply = yield Project_Discussion_Reply_entity_1.Project_discussion_reply.findOne({
            where: {
                id: Number(reply_id),
            },
        });
