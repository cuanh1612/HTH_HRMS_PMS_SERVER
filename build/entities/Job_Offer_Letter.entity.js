...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Job_entity_1.Job, (job) => job.job_offer_letters, {
        onDelete: 'CASCADE',
    }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Job_Application_entity_1.Job_Application, (job_application) => job_application.job_offer_letters, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)(),
