...
const Job_Application_Picture_entity_1 = require("./Job_Application_Picture.entity");
const Location_entity_1 = require("./Location.entity");
const Skill_entity_1 = require("./Skill.entity");
const Job_Application_File_entity_1 = require("./Job_Application_File.entity");
...
__decorate([
    (0, typeorm_1.OneToOne)(() => Job_Application_Picture_entity_1.Job_application_picture, {
        eager: true,
        cascade: true,
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Job_Application_Picture_entity_1.Job_application_picture)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Job_entity_1.Job, (job) => job.job_application, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)(),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Location_entity_1.Location, (location) => location.job_application, {
        onDelete: 'SET NULL',
    }),
    (0, typeorm_1.JoinColumn)(),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => Skill_entity_1.Skill, { eager: true, onDelete: 'CASCADE', nullable: true }),
    (0, typeorm_1.JoinTable)({ name: 'job_application_skill' }),
    __metadata("design:type", Array)
], Job_Application.prototype, "skills", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Job_Application_File_entity_1.Job_application_file, (Job_application_file) => Job_application_file.job_application, {
        onDelete: 'SET NULL',
        nullable: true
    }),
    __metadata("design:type", Array)
