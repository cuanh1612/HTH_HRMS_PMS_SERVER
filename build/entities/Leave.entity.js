...
const Leave_Type_entity_1 = require("./Leave_Type.entity");
var enumStatus;
(function (enumStatus) {
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Leave_Type_entity_1.Leave_type, (Leave_type) => Leave_type.leaves, {
        nullable: false,
        eager: true,
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Leave_Type_entity_1.Leave_type)
