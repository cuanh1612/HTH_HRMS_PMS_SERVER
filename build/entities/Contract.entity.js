...
const Company_Logo_entity_1 = require("./Company_Logo.entity");
const Contract_File_entity_1 = require("./Contract_File.entity");
const Contract_Type_entity_1 = require("./Contract_Type.entity");
const Discussion_entity_1 = require("./Discussion.entity");
const Sign_entity_1 = require("./Sign.entity");
var enumCurrency;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Client_entity_1.Client, (client) => client.contracts, {
        onDelete: 'CASCADE',
        eager: true,
    }),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => Company_Logo_entity_1.Company_logo, {
        cascade: true,
        eager: true,
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Company_Logo_entity_1.Company_logo)
], Contract.prototype, "company_logo", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => Sign_entity_1.Sign, {
        cascade: true,
        eager: true,
        nullable: true
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Sign_entity_1.Sign)
], Contract.prototype, "sign", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Contract_Type_entity_1.Contract_type, (Contract_type) => Contract_type.contracts, {
        onDelete: 'SET NULL',
        eager: true,
        nullable: true,
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Contract_Type_entity_1.Contract_type)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Contract_File_entity_1.Contract_file, (contract_file) => contract_file.contract),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Array)
