...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Employee_entity_1.Employee, (employee) => employee.project_discussion_replies, {
        onDelete: 'CASCADE',
        eager: true,
    }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Project_Discussion_Room_entity_1.Project_Discussion_Room, (project_discussion_room) => project_discussion_room.project_discussion_replies, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Project_Discussion_Room_entity_1.Project_Discussion_Room)
