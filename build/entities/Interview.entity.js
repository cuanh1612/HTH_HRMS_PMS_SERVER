...
const Interview_File_entity_1 = require("./Interview_File.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Job_Application_entity_1.Job_Application, (jobApplication) => jobApplication.interviews, {
        onDelete: "CASCADE"
    }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Interview_File_entity_1.Interview_file, (Interview_file) => Interview_file.interview, {
        onDelete: 'SET NULL',
        nullable: true
    }),
    __metadata("design:type", Array)
