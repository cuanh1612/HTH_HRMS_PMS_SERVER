...
const Project_Discussion_Category_entity_1 = require("./Project_Discussion_Category.entity");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Project_Discussion_Reply_entity_1.Project_discussion_reply, (project_discussion_reply) => project_discussion_reply.project_discussion_room, {
        eager: true,
    }),
    __metadata("design:type", Array)
], Project_Discussion_Room.prototype, "project_discussion_replies", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Project_Discussion_Category_entity_1.Project_discussion_category, (project_discussion_category) => project_discussion_category.project_discussion_rooms, {
        onDelete: 'CASCADE',
        eager: true,
        nullable: true,
    }),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Project_Discussion_Category_entity_1.Project_discussion_category)
], Project_Discussion_Room.prototype, "project_discussion_category", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Employee_entity_1.Employee, (employee) => employee.project_discussion_rooms, {
        onDelete: 'CASCADE',
        eager: true,
        nullable: true,
    }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Project_entity_1.Project, (project) => project.project_discussion_rooms, {
        onDelete: 'CASCADE',
        nullable: true,
    }),
    (0, typeorm_1.JoinColumn)(),
