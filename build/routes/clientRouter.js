...
clientRouter.get('/:clientId/total-projects', (0, checkAuth_1.checkAuth)(['Admin', 'Client']), clientController_1.default.totalProjects);
clientRouter.get('/:clientId/total-earnings', (0, checkAuth_1.checkAuth)(['Admin', 'Client']), clientController_1.default.totalEarnings);
clientRouter.get('/:clientId/status-projects', (0, checkAuth_1.checkAuth)(['Admin', 'Client']), clientController_1.default.statusProjects);
clientRouter.get('/:clientId/projects', (0, checkAuth_1.checkAuth)(['Admin', 'Client']), clientController_1.default.projects);
clientRouter.get('/:clientId/pending-milestone', (0, checkAuth_1.checkAuth)(['Admin', 'Client']), clientController_1.default.pendingMilestone);
clientRouter.post('/csv', (0, checkAuth_1.checkAuth)(['Admin']), clientController_1.default.importCSV);
