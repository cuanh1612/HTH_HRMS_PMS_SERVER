...
clientRouter.post('/delete_may', (0, checkAuth_1.checkAuth)(['Admin']), clientController_1.default.deleteMany);
clientRouter.put('/:clientId', (0, checkAuth_1.checkAuth)(['Admin']), clientController_1.default.update);
clientRouter.get('/', (0, checkAuth_1.checkAuth)(['Admin']), clientController_1.default.getAll);
