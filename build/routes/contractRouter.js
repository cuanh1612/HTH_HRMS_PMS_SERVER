...
contractRouter.post('/', (0, checkAuth_1.checkAuth)(['Admin']), contract_controller_1.default.create);
contractRouter.post('/public-link', (0, checkAuth_1.checkAuth)(['Admin']), contract_controller_1.default.publicLink);
...
contractRouter.post('/csv', (0, checkAuth_1.checkAuth)(['Admin']), contract_controller_1.default.importCSV);
contractRouter.get('/client/:clientId/count-contracts-signed', (0, checkAuth_1.checkAuth)(['Admin', 'Client']), contract_controller_1.default.countContractSignedEmployee);
