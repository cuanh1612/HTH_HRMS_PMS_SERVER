...
eventRouter.delete('/:enventId', (0, checkAuth_1.checkAuth)(['Admin']), eventController_1.default.delete);
eventRouter.put('/:enventId', (0, checkAuth_1.checkAuth)(['Admin']), eventController_1.default.update);
