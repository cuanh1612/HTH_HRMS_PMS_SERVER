...
projectRouter.get('/:projectId/count-status-tasks', (0, checkAuth_1.checkAuth)(['Admin', 'Employee', 'Client']), project_controller_1.default.countstatusTasks);
projectRouter.get('/:projectId/earnings', (0, checkAuth_1.checkAuth)(['Admin', 'Employee', 'Client']), project_controller_1.default.projectEarnings);
projectRouter.get('/:projectId/Hours-logged', (0, checkAuth_1.checkAuth)(['Admin', 'Employee', 'Client']), project_controller_1.default.projectHoursLogged);
